 ...
 * 2016-06-10T16:34:52.048-03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/C:/workspace_novo/ContractFirstWS/src/main/resources/wsdl/Orders.wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/workspace_novo/ContractFirstWS/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/workspace_novo/ContractFirstWS/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
